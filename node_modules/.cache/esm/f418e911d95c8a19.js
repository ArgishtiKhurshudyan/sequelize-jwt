let User,Product,Color,bcrypt,createError,jwt;_d95‍.x([["register",()=>register],["login",()=>login]]);_d95‍.w("../models",[["User",["User"],function(v){User=v}],["Product",["Product"],function(v){Product=v}],["Color",["Color"],function(v){Color=v}]]);_d95‍.w("bcryptjs",[["default",["bcrypt"],function(v){bcrypt=v}]]);_d95‍.w("../utils/error",[["createError",["createError"],function(v){createError=v}]]);_d95‍.w("jsonwebtoken",[["default",["jwt"],function(v){jwt=v}]]);
